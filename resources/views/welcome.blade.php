    ...
    <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] text-sm lg:max-w-4xl">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-4">
                ...
                @else
                    <a class="rounded-xs inline-block border border-transparent px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                        href="{{ route('login') }}">
                        Log in
                    </a>
        ...
        <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a class="rounded-xs inline-block border border-black bg-[#1b1b18] px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white"
